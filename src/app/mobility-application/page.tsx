...
export const metadata: Metadata = {
  title: "BusMe - Aplicación de movilidad",
  ...
  return (
    <>
      ...
      <h2 className="title-page">
          Optimiza{' '}<span className="text-black">tu movilidad</span>
      </h2>
        ...
        <div className="mx-auto space-y-20 pt-2">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-7/12 order-last md:order-first mt-2 md:mt-0 md:pl-16">
              <Image
                src={Busme002}
            ...
            <div className="md:w-6/12">
              <h2 className="font-semibold text-3xl sm:text-4xl mb-6 sm:mb-10">Revisa el trayecto</h2>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Monitorea los transportes</div>
                <p>Visualiza los vehículos en ruta y organiza tu tiempo de manera más eficiente.</p>
              </div>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Consulta la información en tiempo real</div>
              ...
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Ubica los puntos de abordaje más cercanos</div>
                <p>Accede rápidamente a los puntos de abordaje más cercanos donde puedes tomar el transporte.</p>
              </div>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Recibe alertas en tiempo real</div>
              ...
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Consulta las rutas desde tu reloj inteligente</div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-7/12 order-last mt-2 md:mt-0 md:pl-24">
              <Image
                src={Busme003}
            ...
            <div className="md:w-6/12">
              <h2 className="font-semibold text-3xl sm:text-4xl mb-6 sm:mb-10">Califica tu viaje</h2>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Valora tu viaje</div>
              ...
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Quejas y sugerencias</div>
              ...
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Mejora continua</div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-6/12">
              <h2 className="font-semibold text-3xl sm:text-4xl mb-6 sm:mb-10">Obtén información de la ruta</h2>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Disfruta de la información en tiempo real</div>
                <p>Obtén datos actualizados sobre la llegada del transporte desde el punto A hasta el punto B.</p>
              </div>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Visualiza los puntos de abordaje</div>
                <p>Utiliza nuestro sistema para localizar los puntos de abordaje que han sido añadidos por el equipo de administración.</p>
              </div>
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Consulta los transportes</div>
              ...
              <div className="mb-6 sm:mb-8">
                <div className="font-medium text-xl sm:text-2xl mb-2">Nunca te pierdas un transporte</div>
